              ...
              <div className="space-y-6">
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <a href="tel:+254762644702" className="flex items-start gap-4 p-3 rounded-lg hover:bg-muted transition-colors">
                      <div className="bg-primary/10 p-3 rounded-lg">
                        <Phone className="h-6 w-6 text-primary" />
                      </div>
                      <div>
                        <div className="font-semibold">Phone</div>
                        <div className="text-muted-foreground">+254 762 644 702</div>
                      </div>
                    </a>
                ...
                <Card className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900 border-green-200 dark:border-green-800">
                  ...
                  <CardContent>
                    <a href={`https://wa.me/+254762644702?text=${whatsappMessage}`} target="_blank" rel="noopener noreferrer">

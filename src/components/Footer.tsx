    ...
    <footer className="bg-secondary text-secondary-foreground">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
          <h3 className="text-xl font-bold mb-4 text-primary">Simba Cement Stores Ltd.</h3>
          ...
          <div>
            ...
            <div className="space-y-2">
              <a href="tel:+245783016762" className="flex items-center gap-2 text-sm hover:text-primary transition-colors">
        ...
        <div className="border-t border-border/20 mt-8 pt-8 text-center text-sm opacity-90">
          <p>&copy; {new Date().getFullYear()} Simba Cement Stores Ltd. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
